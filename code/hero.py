...
class Hero(Entity):
    ...
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
        ...
        self.image = pygame.image.load('../image/hero/down_idle/hero_knight_idle.PNG').convert_alpha()
        ...
        # stats
        self.stats = {'health': 100, 'energy': 60, 'attack': 10, 'skill': 4, 'speed': 22}
        self.max_stats = {'health': 750, 'energy': 300, 'attack': 70, 'skill': 15, 'speed': 11}
    ...
    def input(self):
        ...
        if not self.attacking:
            ...
            if keys[pygame.K_e] and self.can_switch_magic:
                ...
                if self.magic_index < len(list(skill_data.keys())) - 1:
                    self.magic_index += 1
                else:
                    self.magic_index = 0
                self.magic = list(skill_data.keys())[self.magic_index]
